...
#define SDpower_pin 3  // ================================= PIN 8 FOR THE PCB VER
#define DHT11_pin 9
#define MQ135_powerpin 8 // ================================ PIN 3 FOR THE PCB VER
#define PIN_MQ135 A1
#define DS3231_power A2
MQ135 mq135_sensor(PIN_MQ135);
//DEFINE HERE POWER PINS (MOSFET PINS) FOR OTHER SENSORS
const int critical_voltage = 4.35;
...
void CheckVoltage(){
  int sensorValue = analogRead(battery_pin);
    Battery_Voltage = sensorValue * (4.9/ 1023.0);
  // if(firstvoltage){
